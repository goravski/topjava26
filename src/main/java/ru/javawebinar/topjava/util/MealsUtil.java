...
public class MealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<Meal> meals, LocalTime startTime
...
//                .collect(Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum));
        ...
        return meals.stream()
                ...
                .map(um -> createTo(um, caloriesSumByDate.get(um.getDate()) > caloriesPerDay))
                .collect(Collectors.toList());
    }

    private static UserMealWithExcess createTo(Meal userMeal, boolean excess) {
